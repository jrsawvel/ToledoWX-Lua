...
local html_output = page.get_output("Det/Pontiac NWS Area Forecast Discussion")
local output_filename =  config.get_value_for("htmldir") .. config.get_value_for("wx_det_discussion_output_file")
